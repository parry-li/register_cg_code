package com.tdr.registrationv3.view.CityPicker.view;
...
public class SideLetterNoCityBar extends View {
    ...
    public SideLetterNoCityBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SideLetterNoCityBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SideLetterNoCityBar(Context context) {
        super(context);
    }
